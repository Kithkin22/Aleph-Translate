...
export function AppShellBackButton({ backHref = "/" }: AppShellBackButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleBack}
      className="inline-flex min-h-11 min-w-11 shrink-0 items-center justify-center rounded-lg text-stone-600 transition-colors hover:bg-stone-200/80 active:bg-stone-200 dark:text-stone-400 dark:hover:bg-stone-800"
      aria-label="Go back"
    >
      <svg
        width="20"
